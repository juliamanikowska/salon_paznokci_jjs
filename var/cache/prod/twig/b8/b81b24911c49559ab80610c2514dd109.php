...
($context["app"] ?? null), "request", [], "any", false, false, false, 35), "query", [], "any", false, false, false, 35), "get", [0 => "id_cms_category"], "method", false, false, false, 35)]), "desc" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Add new page", [], "Admin.Design.Help"), "icon" => "add_circle_outline"]];
  ...
  ";
    ...
    public function block_cms_category_grid($context, array $blocks = [])
    {
        ...
        // line 51
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 51, "736793041")->display(twig_array_merge($context, ["grid" => ($context["cmsCategoryGrid"] ?? null)]));
        // line 58
        echo "  ";
    }
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "C:\\xampp\\htdocs\\salon_paznokci_jjs\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Improve\\Design\\Cms\\index.html.twig");
    }
}


/* @PrestaShop/Admin/Improve/Design/Cms/index.html.twig */
class __TwigTemplate_6b0e45624d68c37fe4f2412c2e676cbc___736793041 extends Template
{
    private $source;
    private $macros = [];
